function Outs_Train = Train_FTSVM(A,~ ,B, ~,Samples_Train, C_s, Kernel, QPPs_Solver)
...
%% Main 
  ...
  switch QPPs_Solver
       case 'QP_Matlab'    
           ...
           alpha1 = quadprog(H1, -e2, [], [], [], [], zeros(l2, 1), C1*s2,alpha1_0,Options);
           alpha2 = quadprog(H2,-e1, [], [], [], [], zeros(l1, 1), C2*s1,alpha2_0,Options);
       otherwise
