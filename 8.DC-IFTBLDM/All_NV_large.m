...
% %                 Data_Original = Data_Original(randperm(M_Original), :);
    ...
    if(iData==3)
        ...
        Ctrain=awgn(Ctrain,0.2); % 高斯噪声
        Ctest=awgn(Ctest,0.2); % 高斯噪声
        Ctrain= svdatanorm(Ctrain,'svpline');
        Ctest= svdatanorm(Ctest,'scpline');
    end
    ...
    if(iData==4)
        ...
        Ctrain=awgn(Ctrain,0.3); % 高斯噪声
        Ctest=awgn(Ctest,0.3); % 高斯噪声
        Ctrain= svdatanorm(Ctrain,'svpline');
        Ctest= svdatanorm(Ctest,'scpline');
    end
    ...
    if(iData==5)
        ...
        Ctrain=awgn(Ctrain,0.4); % 高斯噪声
        Ctest=awgn(Ctest,0.4); % 高斯噪声
        Ctrain= svdatanorm(Ctrain,'svpline');
        Ctest= svdatanorm(Ctest,'scpline');
    end
    ...
    if(iData==6)
        ...
        Ctrain=awgn(Ctrain,0.6); % 高斯噪声
        Ctest=awgn(Ctest,0.6); % 高斯噪声
        Ctrain= svdatanorm(Ctrain,'svpline');
        Ctest= svdatanorm(Ctest,'scpline');
    end
