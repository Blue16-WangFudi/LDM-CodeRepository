   ...
   switch Kernel.Type
       case 'Linear'
           if strcmp(FLDM_Type, 'F1_LDM')
               Files_Name = 'Output\Linear\Linear(F1_LDM)';
               Value_Contour = 1;                 %%%%%%%%%%%%%%%% Linear F1_LDM
               Str_Legend = 'Linear F1_LDM';     %%%%%%%%%%%%%%%% Linear F1_LDM
           elseif strcmp(FLDM_Type, 'F2_LDM')
               Files_Name = 'Output\Linear\Linear(F2_LDM)';
               Value_Contour = 1;                 %%%%%%%%%%%%%%%% Linear F2_LDM
               Str_Legend = 'Linear F2_LDM';     %%%%%%%%%%%%%%%% Linear F2_LDM
           else
       ...
       case 'RBF'
           ...
           if strcmp(FLDM_Type, 'F1_LDM')
               Files_Name = 'Output\RBF\RBF(F1_LDM)';
               Value_Contour = 1;                  %%%%%%%%%%%%%%%% RBF-kernel F1_LDM
               Str_Legend = 'RBF-kernel F1_LDM';  %%%%%%%%%%%%%%%% RBF-kernel F1_LDM
           elseif strcmp(FLDM_Type, 'F2_LDM')
               Files_Name = 'Output\RBF\RBF(F2_LDM)';
               Value_Contour = 1;                  %%%%%%%%%%%%%%%% RBF-kernel F2_LDM
               Str_Legend = 'RBF-kernel F2_LDM';  %%%%%%%%%%%%%%%% RBF-kernel F2_LDM
           else
               disp('Wrong parameters are provided.')
               return
           end
