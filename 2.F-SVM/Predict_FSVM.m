function [Acc, Margin, Data_Supporters, Labels_Decision, Outs_Predict] = Predict_FSVM(Outs_Train, Samples_Predict, Labels_Predict)
...
%% Main
 ...
 %------------Label_Decision------------%
   ...
   if strcmp(Kernel.Type, 'Linear')
       Value_Decision = Samples_Predict*Samples_Train'*diag(Labels_Train)*beta+b*abs(Labels_Decision);
   else
