...
%            % TLDM
%            alpha1_ = quadprog(H1, -((lambda1/l2)*H1*y_B + e2), [], [], [], [], zeros(l2, 1), C3*e2,alpha1_0,Options);
%            beta1_ = G1\((lambda1/l2)*K_B'*y_B-K_B'*alpha1);
%            alpha2_ = quadprog(H2, (lambda3/l1)*H2*y_A - e1, [], [], [], [], zeros(l1, 1), C4*e1,alpha2_0,Options);
%            beta2_ = G2\((lambda3/l1)*K_A'*y_A-K_A'*alpha2);
...
%     Outs_Train.alpha1_ = alpha1_;
%     Outs_Train.beta1_ = beta1_;
%     Outs_Train.alpha1_ = alpha2_;
%     Outs_Train.beta2_ = beta2_;
