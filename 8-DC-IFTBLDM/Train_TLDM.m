function Outs_Train = Train_TLDM(A,y_A ,B, y_B,Samples_Train, lambda1,lambda2, C_s, Kernel, QPPs_Solver)
...
%    C2 = C_s.C2;
  ...
  switch QPPs_Solver
       case 'QP_Matlab'    
           ...
           G1 = K_A'*K_A + 2*lambda2*K_B'*Q2*K_B + CR*eye(m);
           G2 = K_B'*K_B + 2*lambda4*K_A'*Q1*K_A + CR*eye(m);
           alpha1_0 = zeros(l2, 1);
           alpha2_0 = zeros(l1, 1);
