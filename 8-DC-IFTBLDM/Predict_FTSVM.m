function Acc = Predict_FTSVM(Outs_Train, Samples_Predict, Labels_Predict,Samples_Train)




%% Main
%    Outs_Train = Outs_SubTrain;
%    Samples_Predict = Samples_SubPredict;
%    Labels_Predict = Labels_SubPredict;
